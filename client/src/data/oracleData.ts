...
export const oracleData: Record<string, OracleData> = {
  daily: {
    ...
    cards: [
      ...
      { name: 'Éveil', meaning: 'Votre conscience s\'élargit et de nouvelles perspectives s\'ouvrent à vous. Accueillez ces prises de conscience : elles peuvent transformer votre regard et orienter vos prochains pas.' },
  ...
  angels: {
    ...
    cards: [
      ...
      { name: 'Ange de la Prospérité', meaning: 'Abondance et réussite matérielle' },
      { name: 'Ange de la Guérison', meaning: 'Rétablissement et bien-être' },
      ...
      { name: 'Ange de la Créativité', meaning: 'Inspiration artistique et innovation' },
      ...
      { name: 'Ange de la Libération', meaning: 'Liberté des peurs et limitations' },
