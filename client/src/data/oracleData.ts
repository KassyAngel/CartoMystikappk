...
export const oracleData: Record<string, OracleData> = {
  daily: {
    ...
    cards: [
      ...
      { name: 'Prosperité', meaning: 'La prospérité entre dans votre vie sous diverses formes : matérielles, émotionnelles ou spirituelles. Accueillez cette abondance avec gratitude et confiance.' },
      ...
      { name: 'Equité', meaning: 'La justice et l\'équilibre vont se rétablir dans vos affaires. Restez intègre et patient : vos actions justes finiront par porter leurs fruits et rétablir l\'harmonie autour de vous.' },
      ...
      { name: 'Générosite', meaning: 'Donnez sans compter aujourd\'hui, non par devoir mais par cœur. Cet élan généreux créera des cercles de réciprocité et attirera des expériences bienfaisantes en retour.' },
