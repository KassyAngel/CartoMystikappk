...
export const oracleData: Record<string, OracleData> = {
  daily: {
    ...
    cards: [
      ...
      { name: 'NouveauDepart', meaning: 'Aujourd’hui marque la fin d’un cycle et l’ouverture d’une nouvelle page de votre vie. C’est un moment idéal pour oser entreprendre ce que vous repoussiez depuis longtemps, que ce soit un projet personnel, professionnel ou sentimental. L’univers vous invite à avancer sans crainte et à accueillir les opportunités qui s’offrent à vous. Chaque pas que vous ferez aujourd’hui posera les bases d’un avenir plus épanouissant.'},
      ...
      { name: 'Lacherprise', meaning: 'Libérez-vous des poids du passé et des inquiétudes inutiles. Acceptez de laisser aller ce que vous ne pouvez contrôler.' },
  ...
  tarot: {
    ...
    cards: [
      { name: 'LeFou', meaning: 'Nouveaux départs, spontanéité, liberté' },
      { name: 'LeBateleur', meaning: 'Créativité, communication, nouveau projet' },
      { name: 'LaPapesse', meaning: 'Intuition, mystère, connaissance cachée' },
      { name: 'LImperatrice', meaning: 'Fertilité, abondance, créativité féminine' },
      { name: 'LEmpereur', meaning: 'Autorité, structure, leadership' },
      { name: 'LePape', meaning: 'Sagesse traditionnelle, guidance spirituelle' },
      { name: 'LAmoureux', meaning: 'Choix, relations, harmonie' },
      { name: 'LeChariot', meaning: 'Victoire, maîtrise de soi, progression' },
      { name: 'LaJustice', meaning: 'Équilibre, vérité, conséquences' },
      { name: 'LHermite', meaning: 'Introspection, sagesse intérieure, guidance' },
      { name: 'LaRouedeLaFortune', meaning: 'Changement, cycles, destinée' },
      { name: 'LaForce', meaning: 'Courage, patience, maîtrise intérieure' },
      { name: 'LePendu', meaning: 'Sacrifice, nouvelle perspective, lâcher-prise' },
      { name: 'LArcaneSansNom', meaning: 'Transformation profonde, fin de cycle' },
      { name: 'Temperance', meaning: 'Modération, guérison, équilibre' },
      { name: 'LeDiable', meaning: 'Dépendances, illusions, matérialisme' },
      { name: 'LaMaisonDieu', meaning: 'Révélation soudaine, changement radical' },  // ✅ CORRIGÉ
