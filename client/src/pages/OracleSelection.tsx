    ...
    <div className="main-content w-full min-h-screen flex flex-col p-2 sm:p-3 pt-14 sm:pt-16 pb-safe">
        ...
        <div className="flex justify-center mb-1.5 sm:mb-2">
          <div className="relative w-10 h-10 sm:w-12 sm:h-12">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="text-2xl sm:text-3xl text-amber-300 drop-shadow-[0_0_10px_rgba(251,191,36,0.5)]">✦</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-4xl px-1 sm:px-2">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-2.5 mb-4">
            {oracles.map((oracle) => (
              <OracleCard
                ...
                icon={oracle.icon}
                useImage={oracle.useImage}
                imageSrc={oracle.imageSrc}
          ...
          <div className="relative mt-6">
            ...
            <button
              ...
              className={`relative w-full p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-[#1a0033] via-[#2d1b69] to-[#1a0033] border-2 border-amber-400/60 hover:border-amber-300 shadow-[0_0_20px_rgba(251,191,36,0.3)] hover:shadow-[0_0_30px_rgba(251,191,36,0.5)] transform hover:scale-[1.02] transition-all duration-300 group overflow-hidden ${selectedOracle === 'bonusRoll' ? 'scale-[1.02] border-amber-300' : ''}`}
            >
              ...
              <div className="relative flex items-center justify-center gap-3 sm:gap-4">
                <div className="relative w-12 h-12 sm:w-16 sm:h-16 flex-shrink-0">
                  ...
                  <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-amber-400/50">
                    <img 
                      src="/Image/Tirage-de.jpg"
                      alt="Tirage Bonus"
                      className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                      style={{filter: 'brightness(1.1) contrast(1.1) drop-shadow(0 2px 8px rgba(0,0,0,0.4))'}}
                    />
                  </div>
                </div>
      ...
      <div className="text-center pt-2">
        <div className="flex justify-center max-w-xs mx-auto px-2">
          <MysticalButton variant="secondary" onClick={onBack} className="w-full sm:w-auto min-h-[42px] text-xs sm:text-sm px-4 sm:px-6">
            ← {t('oracle.back')}
          </MysticalButton>
        </div>
      </div>
